                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="meta_keywords" id="meta_keywords">{{ old('meta_keywords', $contentPage->meta_keywords) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $contentPage->meta_description) }}">
                        ...
                        <div class="form-group">
                            <label for="script_styles">{{ trans('cruds.contentPage.fields.script_styles') }}</label>
                            <textarea class="form-control" name="script_styles" id="script_styles">{{ old('script_styles', $contentPage->script_styles) }}</textarea>
                            @if($errors->has('script_styles'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('script_styles') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.contentPage.fields.script_styles_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <div>
