                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.inventories.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="make" id="make" value="{{ old('make', '') }}" required>
                            @if($errors->has('make'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('make') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vehicle_model" id="vehicle_model" value="{{ old('vehicle_model', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="capacity" id="capacity" value="{{ old('capacity', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fuel_type" id="fuel_type" value="{{ old('fuel_type', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="brakes" id="brakes" value="{{ old('brakes', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mileage" id="mileage" value="{{ old('mileage', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="additional_information" id="additional_information">{!! old('additional_information') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="attachment" id="attachment" value="{{ old('attachment', '') }}">
