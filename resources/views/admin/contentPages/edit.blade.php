    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('script_styles') ? 'is-invalid' : '' }}" name="script_styles" id="script_styles">{{ old('script_styles', $contentPage->script_styles) }}</textarea>
