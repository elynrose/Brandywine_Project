    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inventories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vehicle_model') ? 'is-invalid' : '' }}" type="text" name="vehicle_model" id="vehicle_model" value="{{ old('vehicle_model', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('body') ? 'is-invalid' : '' }}" type="text" name="body" id="body" value="{{ old('body', '') }}" required>
                @if($errors->has('body'))
                    <div class="invalid-feedback">
                        {{ $errors->first('body') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fuel_type') ? 'is-invalid' : '' }}" type="text" name="fuel_type" id="fuel_type" value="{{ old('fuel_type', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('brakes') ? 'is-invalid' : '' }}" type="text" name="brakes" id="brakes" value="{{ old('brakes', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mileage') ? 'is-invalid' : '' }}" type="text" name="mileage" id="mileage" value="{{ old('mileage', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('air_conditioning') ? 'is-invalid' : '' }}" name="air_conditioning" id="air_conditioning" required>
                    ...
                    @foreach(App\Models\Inventory::AIR_CONDITIONING_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('air_conditioning', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('additional_information') ? 'is-invalid' : '' }}" name="additional_information" id="additional_information">{!! old('additional_information') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attachment') ? 'is-invalid' : '' }}" type="text" name="attachment" id="attachment" value="{{ old('attachment', '') }}">
