    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inventories.update", [$inventory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $inventory->title) }}" required>
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('make') ? 'is-invalid' : '' }}" type="text" name="make" id="make" value="{{ old('make', $inventory->make) }}" required>
                @if($errors->has('make'))
                    <div class="invalid-feedback">
                        {{ $errors->first('make') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vehicle_model') ? 'is-invalid' : '' }}" type="text" name="vehicle_model" id="vehicle_model" value="{{ old('vehicle_model', $inventory->vehicle_model) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('body') ? 'is-invalid' : '' }}" type="text" name="body" id="body" value="{{ old('body', $inventory->body) }}" required>
                @if($errors->has('body'))
                    <div class="invalid-feedback">
                        {{ $errors->first('body') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('capacity') ? 'is-invalid' : '' }}" type="text" name="capacity" id="capacity" value="{{ old('capacity', $inventory->capacity) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('engine') ? 'is-invalid' : '' }}" type="text" name="engine" id="engine" value="{{ old('engine', $inventory->engine) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fuel_type') ? 'is-invalid' : '' }}" type="text" name="fuel_type" id="fuel_type" value="{{ old('fuel_type', $inventory->fuel_type) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('brakes') ? 'is-invalid' : '' }}" type="text" name="brakes" id="brakes" value="{{ old('brakes', $inventory->brakes) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mileage') ? 'is-invalid' : '' }}" type="text" name="mileage" id="mileage" value="{{ old('mileage', $inventory->mileage) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('air_conditioning') ? 'is-invalid' : '' }}" name="air_conditioning" id="air_conditioning" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('additional_information') ? 'is-invalid' : '' }}" name="additional_information" id="additional_information">{!! old('additional_information', $inventory->additional_information) !!}</textarea>
            ...
            <div class="form-group">
                <label for="photos">{{ trans('cruds.inventory.fields.photos') }}</label>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1" {{ $inventory->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="featured">{{ trans('cruds.inventory.fields.featured') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="published" id="published" value="1" {{ $inventory->published || old('published', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="published">{{ trans('cruds.inventory.fields.published') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attachment') ? 'is-invalid' : '' }}" type="text" name="attachment" id="attachment" value="{{ old('attachment', $inventory->attachment) }}">
