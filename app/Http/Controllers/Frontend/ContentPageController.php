...
class ContentPageController extends Controller
{
    ...
    public function index()
    {
       // abort_if(Gate::denies('content_page_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');
        ...
        $contentPages = ContentPage::with(['tags', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.contentPages.create', compact('tags'));
    }
    ...
    public function edit(ContentPage $contentPage)
    {
        ...
        $contentPage->load('tags');

        return view('frontend.contentPages.edit', compact('contentPage', 'tags'));
    }
